<section class="content-header">
      <h1>
        Stock In
        <small>Barang Masuk/ Stock in</small>
      </h1>
      <ol class="breadcrumb">
                ...
                <form action="<?=site_url('stock/process')?>" method="post">
                    ...
                    <div class="form-group input-group"> 
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-info ntn-flat" data-toggle="modal" data-target="#modal-item">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="unit_name" value="-" id="unit_name" class="form-control" readonly>
                            </div>
                    ...
                    <div class="form-group">
                        <label>Detail *</label>
                        <input type="text" name="detail" class="form-control" placeholder="Kulakan/tambahan/ dan lain-lain" >
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" name="in_add" class="btn btn-success btn-flat"><i class="fa fa-paper-line"></i>Save</button>
